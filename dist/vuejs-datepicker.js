(function (global, factory) {
  ...
  var script = {
    ...
    watch: {
      resetTypedDate: function resetTypedDate(o, n) {
        var _this = this;
    ...
    methods: {
      ...
      parseTypedDate: function parseTypedDate(event) {
        ...
        if (this.typeable) {
          ...
          var input = this.cleanDateInput(this.input.value, event);
          var typedDate;
          /**
          ...
          var separator = [" ", ".", ",", "-", "/"].find(function (val) {
            var count = (_this3.format.match(new RegExp(val, "g")) || []).length;
            return count === 2;
          }, "/");
      ...
      inputBlurred: function inputBlurred() {
        if (this.typeable && this.typedDate) {
          var mformat = typeof this.format == 'function' ? this.format() : this.format;
          mformat = this.format.toUpperCase();
          var d = moment(this.typedDate, mformat);
